    ...
    <div className="space-y-4">
          ...
          <div className="flex">
            {images.map((image, index) => (
              <div className="relative flex-[0_0_100%]" key={index}>
                <div className="w-full h-[260px] sm:h-[320px] md:h-[420px] lg:h-[480px] bg-muted/40 flex items-center justify-center overflow-hidden">
                  <img
                    src={encodeURI(image)}
                    alt={`Slide ${index + 1}`}
      ...
      <div className="flex gap-2 overflow-auto pb-2">
        {images.map((image, index) => (
          ...
          >
            <div className="w-[120px] h-[70px] sm:w-[140px] sm:h-[80px] bg-muted/40 flex items-center justify-center overflow-hidden">
              <img
                src={encodeURI(image)}
